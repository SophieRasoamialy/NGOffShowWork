                    ...
                    <div class="w-3/5 d-flex align-items-center rounded-r-lg bg-gray-100">
                        ...
                        <div class="card-body  text-black px-5">
                            <form method="POST" action="{{ route('login') }}">
                                ...
                                <h2 class="mt-2 text-center text-xl font-bold leading-9 tracking-tight text-gray-900">Réinitialiser le mot de passe</h2>
                                ...
                                @csrf
                                    ...
                                    <div class="pt-1 mb-4">
                                        ...
                                        type="submit">{{ __('Envoyer le lien de réinitialisation du mot de passe') }}</button>
                                    </div>
                                </form>
                    </div>
                </div>
