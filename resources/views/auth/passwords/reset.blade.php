                ...
                <div class="row g-0 bg-gray-800 rounded-2xl">
                    ...
                    <div class="col-md-6 col-lg-7 d-flex align-items-center rounded-r-lg bg-gray-100">
                        ...
                        <div class="card-body p-3 p-lg-5 text-black">
                            ...
                            <h5 class="fw-normal mb-3 pb-3" style="letter-spacing: 1px;">Réinitialiser le mot de passe
                            </h5>
                            ...
                            <div class="form-outline mb-4">
                                ...
                                <label class="form-label" for="password-confirm">Mot de passe</label>
                            </div>
                            <div class="pt-1 mb-4">
                                <button class="mt-3 text-lg font-semibold 
                                bg-gray-800 w-full text-white rounded-lg
                                px-6 py-3 block shadow-xl hover:text-white hover:bg-black form-control" type="submit">Réinitialiser le mot de passe</button>
                            </div>
                    </form>
                        </div>
                </div>
