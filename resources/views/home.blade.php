                    ...
                    <ul class="navbar-nav ms-auto">
                        ...
                        @guest
                            ...
                            @if (Route::has('register'))
                                <li class="nav-item">
                                    <a type="button" href="{{ route('register') }}" class="text-blue-700 hover:text-white border-2 border-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2 ">
                                        {{ __('Register') }}
                                    </a>
                                </li>
                            @endif
