...
<div class="bg-gray-800 h-screen mt-10">
    <div class="bg-gray-800 p-6 w-2/4  mx-auto">
      ...
      <div class="text-center mt-3">
          <h3 class="md:text-2xl text-base text-white font-semibold text-center">Référence envoyé!</h3>
          <p class="text-gray-400 my-2">Votre demande est encours de traitement.</p>
            <p class="text-gray-400">Vous recevrez la notification de la réponse</p>
          <p class="text-gray-400"> En attendant, commencez à visualiser les projets!
          </p>
