<div class="my-20">
    <h1 class="mb-5 text-center text-lg text-green-800">Demande d'abonnement</h1>
    <div class="  relative">
        <table class="table  text-sm text-justify w-full text-gray-500 dark:text-gray-400">
        ...
        <tbody>
            ...
            <tr class="bg-white dark:bg-gray-800">
                ...
                <td class="py-4 px-6">
                    {{date_format($row->created_at, ' j F Y, H\hi')}}
                </td>
                <td class="py-4 px-6">
                    {{$row->mode_paiement}}
                </td>
                ...
                <td class="py-4 px-6">
                    @if($row->abonnement_type == "cdo_basic" )
                    Basique
                    @else
                    Premium
                    @endif
