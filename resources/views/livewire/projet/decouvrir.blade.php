                ...
                <div class="flex ">
                    ...
                    <div class="  flex-1 shadow-lg bg-gray-700 rounded-lg ml-60	p-5  ">
                        ...
                        <div class="divide-y divide-gray-300 ">
                           <h3 class="text-center text-gray-200 mb-2 text-base">Tous les projets</h3>
                           <div class="  ">
                            <div class=" row col-md-12 mb-5 ">

                            @foreach($tout_projets as $projet)
                                <div class=" mt-3 col-md-6 mb-3 ftco-animate d-flex fadeInUp ftco-animated">
                    ...
                    <a href="/projets" class="float-left"><< Retour </a>
